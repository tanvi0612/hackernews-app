...
export default class Container extends Component {
  constructor(props) {
    ...
    console.log("Inside Container.js constructor function");
  }

  componentDidMount() {
    console.log("Inside Container.js componentDidMount");
  ...
  render() {
    console.log("Indside Container.js render function");
    return (
      <div style={{...styles.container, ...{width: this.width, height: this.height}}}>
        ...
        />
        {console.log("After the <Story> tag inside Container.js render")}
